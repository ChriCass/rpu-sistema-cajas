@props(['type' => 'success', 'title' => 'Éxito', 'message' => 'Mensaje por defecto', 'username' => 'Usuario'])
  ...
  <div class="{{ $class }} px-4 py-3 rounded relative" role="alert">
    ...
    <span class="absolute top-0 bottom-0 right-0 px-4 py-3">
      <button @click="show = false">
        <svg class="fill-current h-6 w-6 {{ $icon }}" role="button" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
          <title>Close</title>
