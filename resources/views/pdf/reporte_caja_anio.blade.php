...
<body>
    <div class="container">
        <div class="header">
            ...
            <h2>Reporte de Caja <strong>POR AÑO</strong>  </h2>
            <div class="totals">
            ...
            <p><strong>Año:</strong> {{ $año }} | <strong>Caja:</strong> {{ $id_caja }}</p>
        </div>
                    ...
                    @foreach ($movimientos as $movimiento)
                        <tr>
                            <td class="px-4 py-2 border-b">{{ $movimiento->id_mes }}</td>
                                <td>{{ $movimiento->numero_apertura }}</td>
