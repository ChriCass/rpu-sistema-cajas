<div>
    ...
    <div class="p-4">
        <x-card title="Editar Vaucher De Pago">
            <div>
                {{-- Alerta de éxito --}}
            ...
            <div class="flex flex-wrap -mx-2 mt-4">
                ...
                <div class="w-full md:w-4/12 px-2 flex items-center justify-end">
                    @livewire('edit-cuadro-de-pendientes-ventas-modal', ['aperturaId' => $aperturaId,'numMov' => $numMov, 'contenedor' => $contenedor, 'moneda' => $moneda])
                </div>
