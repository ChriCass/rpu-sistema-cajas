                ...
                <table class="min-w-full bg-white border border-gray-300">
                    <thead class="bg-gray-200">
                        <tr>
                            ...
                            <th class="px-4 py-2 border-b">IDOC</th>
                    ...
                    <tbody>
                        @foreach ($movimientos as $movimiento)
                            <tr>
                                <td class="px-4 py-2 border-b">{{ $movimiento->id_mes }}</td>
                                <td class="px-4 py-2 border-b">{{ $movimiento->numero_apertura }}</td>
                                <td class="px-4 py-2 border-b">{{ $movimiento->fecha }}</td>
                                ...
                                <td class="px-4 py-2 border-b">{{ $movimiento->numero_serie }}</td>
                                <td class="px-4 py-2 border-b">{{ number_format($movimiento->monto, 2) }}</td>
