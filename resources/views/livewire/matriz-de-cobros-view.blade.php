<div>
    ...
    <div class="container mx-auto p-4">
        <div class="p-4 sm:p-6">
            <h2 class="text-xl font-semibold text-gray-900 mb-6">Matriz de Cobros</h2>
        ...
        <div class="overflow-x-auto mb-6">
            <div class="bg-white p-4 rounded-lg shadow-md mb-4">
                <div class="mb-3">
                    ...
                    <p class="text-sm text-gray-500">Filtra la matriz de cobros usando los siguientes campos. Todos los filtros se aplican en tiempo real.</p>
                </div>
