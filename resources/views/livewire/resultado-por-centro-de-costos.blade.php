                    ...
                    <div class="overflow-x-auto">
                        <table class="min-w-full bg-white border border-gray-300">
                            <thead class="bg-gray-100">
                                <tr>
                                    <th class="sticky left-0 bg-gray-100 px-4 py-3 border-b font-medium text-sm text-gray-700 uppercase tracking-wider">FAMILIA</th>
                                ...
                                @if(!empty($movimientos) && $movimientos->count())
                                    @foreach ($movimientos as $movimiento)
                                        <tr class="hover:bg-gray-100 transition-colors duration-150">
                                            <td class="sticky left-0 px-4 py-2 border-b group-hover:bg-gray-100">{{ $movimiento->familia_descripcion }}</td>
                                    ...
                                    <!-- Total Ingresos -->
                                    <tr class="bg-gray-50">
                                        <td class="sticky left-0 bg-gray-50 px-4 py-2 border-b"></td>
                                    ...
                                    <!-- Utilidad/Pérdida -->
                                    <tr class="bg-teal-50">
                                        <td class="sticky left-0 bg-teal-50 px-4 py-2 border-b"></td>
                                        <td class="px-4 py-2 border-b"></td>
