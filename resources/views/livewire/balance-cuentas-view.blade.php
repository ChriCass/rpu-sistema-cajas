    ...
    <div class="container mx-auto p-4">
        <x-card>
            ...
            <div class="flex justify-center space-x-4 mt-6">
              ...
              <button wire:click="exportBalanceCuentas"
                            ...
                            @foreach ($registros as $registro)
                                <tr>
                                    ...
                                    <td class="px-4 py-2 border-b">
                                        {{ number_format($registro->debe ?? 0, 2, '.', ',') }}</td>
                                    <td class="px-4 py-2 border-b">
                                        {{ number_format($registro->haber ?? 0, 2, '.', ',') }}</td>
                                    <td class="px-4 py-2 border-b">
                                        {{ number_format($registro->sumDebe ?? 0, 2, '.', ',') }}</td>
                                    <td class="px-4 py-2 border-b">
                                        {{ number_format($registro->sumHaber ?? 0, 2, '.', ',') }}</td>
                                    <td class="px-4 py-2 border-b">
