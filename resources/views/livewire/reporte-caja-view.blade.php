        ...
        <x-card>
            ...
            <div class="flex flex-wrap -mx-4">
                <div class="w-full md:w-1/3 px-4 mb-6">
                    ...
                    <x-select label="Mes" placeholder="Selecc." :options="$meses" wire:model="mes" option-label="descripcion" option-value="id" />
                    <x-select label="Caja" placeholder="Selecc." :options="$cajas" wire:model="id_caja" option-label="descripcion" option-value="id" />
                ...
                <div class="w-full md:w-1/3 flex flex-col items-center px-4 mb-6">
                    <button wire:click="procesarReporte"
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                            ...
                            <path d="M20 8l-6-6H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8zM9 19H7v-9h2v9zm4 0h-2v-6h2v6zm4 0h-2v-3h2v3zM14 9h-1V4l5 5h-4z"></path>
                        </svg>
                        <span>Procesar</span>
                    </button>
                    ...
                    <div class="bg-white border border-teal-500 rounded-lg p-6 shadow-md w-full">
                        ...
                        <p class="text-gray-700 font-bold">SALDO INICIAL: <span class="font-normal">{{ number_format($saldo_inicial, 2) }}</span></p>
                        <p class="text-gray-700 font-bold">VARIACIÓN: <span class="font-normal">{{ number_format($variacion, 2) }}</span></p>
                        <p class="text-gray-700 font-bold">SALDO FINAL: <span class="font-normal">{{ number_format($saldo_final, 2) }}</span></p>
                    </div>
                </div>
            </div>
                ...
                <table class="min-w-full bg-white border border-gray-300">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="px-4 py-2 border-b">{{ $movimiento->familia_descripcion ?? 'MOVIMIENTOS' }}</td>
