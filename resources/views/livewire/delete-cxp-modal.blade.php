    ...
    <x-modal name="persistentModal" wire:model="openModal" persistent>
        <x-card>
            ...
            <x-alert title="¡Advertencia Importante!" negative padding="small">
                <x-slot name="slot">
                    <p class="text-red-600 font-semibold">Estás a punto de <b>eliminar la cuenta por pagar numero: {{$idcxp }}</b>.</p>
            ...
            <x-slot name="footer" class="flex justify-end gap-x-4">
                ...
                <x-button negative label="Eliminar" wire:click="deleteCXP" />
            </x-slot>
        </x-card>
    </x-modal>
</div>
