            ...
            <div class="flex justify-between items-center mb-4">
                <div class="space-x-4">
                    <label class="inline-flex items-center">
                        <input type="radio" class="form-radio text-teal-600" wire:model.live="status" name="status" value="pendiente">
                        <span class="ml-2">Pendiente</span>
                    </label>
                    <label class="inline-flex items-center">
                        <input type="radio" class="form-radio text-teal-600" wire:model.live="status" name="status" value="pagado">
                        <span class="ml-2">Pagado</span>
                    </label>
                    <label class="inline-flex items-center">
                        <input type="radio" class="form-radio text-teal-600" wire:model.live="status" name="status" value="todo">
                        <span class="ml-2">Todo</span>
                    </label>
                </div>
                <div class="flex space-x-4">
                    <button wire:click="procesar" class="bg-blue-600 text-white font-bold py-2 px-4 rounded hover:bg-blue-700">
                        Procesar
                    </button>
                </div>
                    <button href="{{ route('movimientos') }}" wire:navigate  class="bg-blue-600 text-white font-bold py-2 px-4 rounded hover:bg-blue-700">
                        Movimientos
                    </button>
                </div>
            </div>
