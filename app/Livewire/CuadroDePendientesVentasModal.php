...
class CuadroDePendientesVentasModal extends Component
{
    ...
    public function mount($aperturaId)
    {
        ...
        // Ejecutar la nueva consulta y almacenar los resultados en $pendientes
        $this->pendientes = DB::select("
            ...
            FROM (
                    ...
                    FROM (
                        ...
                        FROM (
                            ...
                            LEFT JOIN (
                                ...
                                FROM cuentas 
                                LEFT JOIN tipodecuenta 
                                ON cuentas.id_tCuenta = tipodecuenta.id
                ...
                LEFT JOIN tabla10_tipodecomprobantedepagoodocumento 
                ON CON3.id_t10tdoc = tabla10_tipodecomprobantedepagoodocumento.id 
                WHERE monto > 0
            ) CON4  
            WHERE fechaEmi <= ? 
            AND Mon = 'PEN' 
