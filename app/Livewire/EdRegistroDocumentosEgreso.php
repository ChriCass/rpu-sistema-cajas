...
{   
    ...
    public function submit()
    {
        ...
        try {
            ...
            // Validación de destinatario si familiaId es '001'
            ...
            // Bloquear las consultas para obtener movimientos y borrar registros
    ...
    public function registrarMovimientoCaja($documentoId, $entidadId, $fechaEmi, $movcaja, $movlibro)
    {
        ...
        try {
            ...
            // Consultar la familia con bloqueo pesimista
            $tipoFamilia = Familia::select('id_tipofamilias')
                ->lockForUpdate() // Bloqueo pesimista
                ->where('id', $this->familiaId)
                ->get()
